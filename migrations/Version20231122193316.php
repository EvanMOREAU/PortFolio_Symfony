 ...
 */
final class Version20231122193316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tbl_studies (id INT AUTO_INCREMENT NOT NULL, place VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, text LONGTEXT NOT NULL, website VARCHAR(255) DEFAULT NULL, img_path VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
